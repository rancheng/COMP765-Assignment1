...
if("TRUE" STREQUAL "TRUE")
  set(aquaautopilot_SOURCE_PREFIX /home/ran/Documents/Assignment1/src/aquaautopilot)
  set(aquaautopilot_DEVEL_PREFIX /home/ran/Documents/Assignment1/devel)
  ...
  set(aquaautopilot_INSTALL_PREFIX /home/ran/Documents/Assignment1/install)
...
if(NOT "/home/ran/Documents/Assignment1/devel/include " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/aquaautopilot " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/aquaautopilot' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'David Meger <dmeger@cim.mcgill.ca>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'aquaautopilot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'aquaautopilot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ran/Documents/Assignment1/src/aquaautopilot/${idir}'.  ${_report}")
    endif()
