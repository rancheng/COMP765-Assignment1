...
if("TRUE" STREQUAL "TRUE")
  set(aqua_gait_SOURCE_PREFIX /home/ran/Documents/Assignment1/src/aqua_gait)
  set(aqua_gait_DEVEL_PREFIX /home/ran/Documents/Assignment1/devel)
  ...
  set(aqua_gait_INSTALL_PREFIX /home/ran/Documents/Assignment1/install)
...
if(NOT "/home/ran/Documents/Assignment1/devel/include;/home/ran/Documents/Assignment1/src/aqua_gait/include " STREQUAL " ")
  set(aqua_gait_INCLUDE_DIRS "")
  set(_include_dirs "/home/ran/Documents/Assignment1/devel/include;/home/ran/Documents/Assignment1/src/aqua_gait/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'aqua_gait' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'aqua_gait' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ran/Documents/Assignment1/src/aqua_gait/${idir}'.  ${_report}")
    endif()
...
set(aqua_gait_EXPORTED_TARGETS "aqua_gait_generate_messages_cpp;aqua_gait_generate_messages_eus;aqua_gait_generate_messages_lisp;aqua_gait_generate_messages_nodejs;aqua_gait_generate_messages_py")
...
set(depends "aquacore;roscpp;rospy;sensor_msgs;std_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${aqua_gait_dep}_FOUND)
      find_package(${aqua_gait_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${aqua_gait_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
