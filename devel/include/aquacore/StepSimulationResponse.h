// Generated by gencpp from file aquacore/StepSimulationResponse.msg
// DO NOT EDIT!


#ifndef AQUACORE_MESSAGE_STEPSIMULATIONRESPONSE_H
#define AQUACORE_MESSAGE_STEPSIMULATIONRESPONSE_H
...
struct StepSimulationResponse_
{
  ...
  typedef boost::shared_ptr< ::aquacore::StepSimulationResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::aquacore::StepSimulationResponse_<ContainerAllocator> const> ConstPtr;

}; // struct StepSimulationResponse_

typedef ::aquacore::StepSimulationResponse_<std::allocator<void> > StepSimulationResponse;

typedef boost::shared_ptr< ::aquacore::StepSimulationResponse > StepSimulationResponsePtr;
typedef boost::shared_ptr< ::aquacore::StepSimulationResponse const> StepSimulationResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::aquacore::StepSimulationResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::aquacore::StepSimulationResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::aquacore::StepSimulationResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::aquacore::StepSimulationResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::aquacore::StepSimulationResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::aquacore::StepSimulationResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::aquacore::StepSimulationResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::aquacore::StepSimulationResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::aquacore::StepSimulationResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::aquacore::StepSimulationResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x95407e38eb7e3d32ULL;
  static const uint64_t static_value2 = 0xda22f30447fb9d6cULL;
};

template<class ContainerAllocator>
struct DataType< ::aquacore::StepSimulationResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "aquacore/StepSimulationResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::aquacore::StepSimulationResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::aquacore::StepSimulationResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::aquacore::StepSimulationResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::aquacore::StepSimulationResponse_<ContainerAllocator>& v)
  {
    s << indent << "timestamp: ";
...
#endif // AQUACORE_MESSAGE_STEPSIMULATIONRESPONSE_H
